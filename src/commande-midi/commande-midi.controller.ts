...
export class CommandeMidiController {
  constructor(private readonly commandeMidiService: CommandeMidiService) {}
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateCommandeMidiDto: UpdateCommandeMidiDto) {
